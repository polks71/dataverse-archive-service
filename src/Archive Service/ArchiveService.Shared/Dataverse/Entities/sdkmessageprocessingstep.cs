...
namespace ArchiveService.Dataverse
{
	...
	public partial class SdkMessageProcessingStep : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public ArchiveService.Dataverse.PluginType plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<ArchiveService.Dataverse.PluginType>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintype_sdkmessageprocessingstep");
				this.SetRelatedEntity<ArchiveService.Dataverse.PluginType>("plugintype_sdkmessageprocessingstep", null, value);
		...
		public ArchiveService.Dataverse.PluginType plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<ArchiveService.Dataverse.PluginType>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintypeid_sdkmessageprocessingstep");
				this.SetRelatedEntity<ArchiveService.Dataverse.PluginType>("plugintypeid_sdkmessageprocessingstep", null, value);
		...
		public ArchiveService.Dataverse.SdkMessageFilter sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<ArchiveService.Dataverse.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessagefilterid_sdkmessageprocessingstep");
				this.SetRelatedEntity<ArchiveService.Dataverse.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
		...
		public ArchiveService.Dataverse.SdkMessage sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<ArchiveService.Dataverse.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessageprocessingstep");
				this.SetRelatedEntity<ArchiveService.Dataverse.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null, value);
