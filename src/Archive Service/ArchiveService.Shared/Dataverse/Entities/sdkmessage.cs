...
namespace ArchiveService.Dataverse
{
	...
	public partial class SdkMessage : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<ArchiveService.Dataverse.SdkMessageFilter> sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntities<ArchiveService.Dataverse.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessagefilter");
				this.SetRelatedEntities<ArchiveService.Dataverse.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null, value);
		...
		public System.Collections.Generic.IEnumerable<ArchiveService.Dataverse.SdkMessageProcessingStep> sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessageprocessingstep");
				this.SetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null, value);
