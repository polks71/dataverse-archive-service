...
namespace ArchiveService.Dataverse
{
	...
	public partial class PluginType : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<ArchiveService.Dataverse.SdkMessageProcessingStep> plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintype_sdkmessageprocessingstep");
				this.SetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null, value);
		...
		public System.Collections.Generic.IEnumerable<ArchiveService.Dataverse.SdkMessageProcessingStep> plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("plugintypeid_sdkmessageprocessingstep");
				this.SetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null, value);
