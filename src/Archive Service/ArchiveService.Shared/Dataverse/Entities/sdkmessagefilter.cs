...
namespace ArchiveService.Dataverse
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<ArchiveService.Dataverse.SdkMessageProcessingStep> sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessagefilterid_sdkmessageprocessingstep");
				this.SetRelatedEntities<ArchiveService.Dataverse.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
		...
		public ArchiveService.Dataverse.SdkMessage sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntity<ArchiveService.Dataverse.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessagefilter");
				this.SetRelatedEntity<ArchiveService.Dataverse.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
